...
public class UDPlistener extends Service {
	 ...
	 */
	private static void alarmNotif(JSONObject jsonValues, Context notifContext) {
		int hasAlarmInt;
		int hasAlarmActive;
		...
		if (hasAlarmInt == 1 && hasAlarmActive == 1) {
			...
			Notification.Builder myNotifBuilder;
			if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
				myNotifBuilder = new Notification.Builder(notifContext)
			...
			Notification alarmNotification = myNotifBuilder.getNotification();
	...
	private Notification ServiceNotification(Context context) {
		...
		/* Pointer to notification builder for export/import arrow */
		Notification.Builder myNotifBuilder;
		myNotifBuilder = new Notification.Builder(context)
		...
		/* Pointer to notification */
		return myNotifBuilder.getNotification();
	}
